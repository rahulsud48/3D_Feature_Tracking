...
int main(int argc, const char *argv[])
{
    ...
    string detectorType = "ORB"; // "SHITOMASI", "HARRIS", "FAST", "BRISK", "ORB", "AKAZE"
    string descriptorType = "BRIEF"; // "BRISK", "BRIEF", "ORB", "FREAK", "AKAZE"
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex+=imgStepWidth)
    {
        ...
        descKeypoints((dataBuffer.end() - 1)->keypoints, (dataBuffer.end() - 1)->cameraImg, descriptors, descriptorType, descInfo);
